    ...
    <div class="container">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Summarize</li>
            </ol>
        </nav>
                        ...
                        <table class="table table-sm text-center">
                            ...
                            @foreach($notes as $note)
                                <tr>
                                    ...
                                    @endif
                                    <td>
                                        <a href="{{route('show.summarize.note',['id'=>$note->id])}}" class="btn btn-success btn-sm"><i data-feather="eye"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
